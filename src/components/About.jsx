                  ...
                  >
                    ...
                    >
                      <p style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>
                        ...
                        DEPSTAR with a deep love for problem-solving and
                        building innovative solutions.
                      </p>
                      <p style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>
                        Currently maintaining a{" "}
                        <strong className="text-orange-200">CGPA of 8.7</strong>
                        , I believe in balancing academic excellence with
                        practical application. I've solved over{" "}
                      ...
                      <p style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>
                        ...
                        using the MERN stack, where I enjoy bringing ideas to
